...
_SUMMARY_SYSTEM_PROMPT = (
    ...
    "1. Если в сообщении одна тема/мысль — одно короткое предложение, "
    "только суть, без воды и без вступлений.\n"
    "2. Если в сообщении НЕСКОЛЬКО разных важных тем, вопросов, "
    "новостей или просьб (даже если оно короткое) — выдели КАЖДУЮ "
    "отдельным буллетом строкой через дефис «- ». Не сваливай всё в "
    "одну фразу, если темы реально разные.\n"
    "3. Не вписывай в выжимку приветствия, прощания, очевидное "
    "(«сказал что...»), флуд, маты ради эмоций. Только смысл и факты.\n"
    "4. Сохрани тон и смысл, не приукрашивай. Если сообщение "
    "бессмысленное — одно предложение о чём оно.\n"
    "5. Без кавычек, без markdown-форматирования (никаких **, # и т.д.). "
    "Только обычный текст или буллеты через дефис.\n"
    "6. Максимум 5 буллетов. Если тем больше — сгруппируй похожие.\n"
    "7. Выжимка всегда написана от третьего лица и никогда не обращается "
    "к читателю. Не переноси из речи формы «ты», «тебя», «тебе», «твой», "
    "«у тебя» буквально. Перефразируй их через «собеседник», «кого-то» "
    "или третье лицо по контексту: например, «Полковник спрашивает "
    "собеседника, почему у него такой профиль»."
)
...
_SUMMARY_SPEAKER_HINT = (
    ...
    "к нему самому. Называй адресата «собеседником» или «кем-то» и не "
