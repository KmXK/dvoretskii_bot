...
class BillV2:
    ...
    collection_context: list[str] = field(default_factory=list)
    # Накопленный контекст веб-сбора (чанки "[Текст]/[Фото]/[Голосовое]"), тот же
    # формат, что context_items в чат-сессии. Позволяет выйти из веб-сбора и
    # вернуться, не потеряв надиктованное/приложенное. Пуст для чат-счетов.
