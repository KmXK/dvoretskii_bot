...
Тонкая настройка бота по чатам: chat-admin'ы включают/выключают группы функций, global-admin'ы менеджат глобальные роли (см. `docs/settings.md`). Та же страница доступна в web — `/settings`.
