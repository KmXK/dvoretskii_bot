# Baseline vs v2_integer_qty (full corpus)
...
|---|---|---|---|---|
| baseline | 0.955 | 0.980 | 0.991 | **0.975** |
| v2_integer_qty | 0.994 | 0.959 | 0.997 | **0.983** |
...
| hookah_half | 1.00 | ERR | 1.00 |
| hookah_third | 1.00 | 0.65 ⚠ | 1.00 |
| two_hookahs_subgroups | 0.95 | 1.00 | 1.00 |
...
### `hookah_half` × `v2_integer_qty` × `google/gemini-2.5-pro` — score 0.00
...
### `hookah_third` × `v2_integer_qty` × `google/gemini-2.5-pro` — score 0.65

_speaker owes one third, other person paid_

- currency_ok=True items 0/1 per_person=1.00 creditor=0.00 questions_ok=True
- expected per-person: `{'Паша': 1633}`
- actual per-person:   `{'Паша': 1633}`
